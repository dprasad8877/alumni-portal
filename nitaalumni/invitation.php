...
<div class="row">
	...
	<table width="600" border="1" cellspacing="1" cellpadding="50" align="" cols="">
		
		<form action="mail_api/phpemail1.php" method="post"  enctype="multipart/form-data" >
			<h1>Enter Invitation Detail</h1> <br> <br>
			<div align="left">
				<font size="3" color="#006633"><strong><u>invitation heading: </u>  </strong></font> <br><input type="text" placeholder="heading" required="required" name="head" id="heading" autofocus  />
			</div>
			<div class="controls">		
				<font size="3" color="#006633"><strong><u>Invitation Message:  </u>   </strong> </font> <br><textarea  class="span4" name="msg" placeholder="message"rows="10" cols="70" required="required"></textarea>
				</div>		
				
			<div align="left">
				<input class="btn btn-success" type="submit" name="submit" value="send Invitation" />&nbsp;&nbsp;&nbsp;
