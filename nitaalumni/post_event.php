...
<div class="row">
	<div class="span8">		
		...
		<form action="event_database.php"  enctype="multipart/form-data" method="post" >
			<h1>Enter Event  Detail</h1> <br> <br>
			
				<font size="3" color="#006633"><strong><u>Event Heading: </u>  </strong></font> <br><input type="text" placeholder="heading" required="required" name="head" id="heading" autofocus />
		
			<br>
				<font size="3" color="#006633"><strong><u>Event Description:  </u>   </strong> </font> <br><textarea class="span4" name="msg"placeholder="message"rows="10" cols="" required="required" ></textarea>
				
			<br><br>
				<input class="btn btn-success" type="submit" name="submit" value="Post Events" />&nbsp;&nbsp;&nbsp;<a href="register.php"><br><br>
	...
	<div class="span4">
		...
		<div class="box1">
			<div class="inner">
				<ul class="ul_cat">
				<li> <a href="event.php">News and Events</a>
				  <?php
				if(isset($_SESSION['email']))
					{
